...
class ReportSpendingDetailPage extends StatelessWidget {
  final SpendingReportItem item;

  const ReportSpendingDetailPage({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Detail Laporan Pengeluaran'),
